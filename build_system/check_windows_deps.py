...
def check_python_packages():
    ...
    for package in required_packages:
        try:
            ...
            elif package == 'ordered_set':
                import ordered_set
                print(f"   {package}: Found")
            elif package == 'zstandard':
                import zstandard
                print(f"   {package}: Found")
            elif package == 'pandas':
                import pandas
...
def check_disk_space():
    ...
    try:
        ...
        if free_gb < 2:
            ...
            print("    Low disk space (recommended: 5+ GB)")
        else:
...
def main():
    ...
    if args.fix:
        ...
        if not results['visual_cpp']:
            print("\n Visual C++ Redistributable installation requires administrator privileges")
